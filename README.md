...
**Функционал:**
- Recipe Book UI, items display, routing, pre-push rules
- connect Recipe Book to inventoryStore via bridge

**Релиз:** https://github.com/vv0rkz/mfe-fridgecraft/releases/tag/v1.1.0
